...
public class EditNoteView extends JDialog {
	...
	public EditNoteView(Note note) {
		...
		this.oldNote = note;
		this.parentGroup = this.oldNote.getAssociatedGroup();
		this.initialize();
		this.tf_title.setText(this.oldNote.getTitle());
		this.ta_note.setText(this.oldNote.getNote());
		this.tf_link.setText(this.oldNote.getLink());
	}
		...
		if (this.btn_cancel == null) {
			...
			this.btn_cancel.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					EditNoteView.this.cancelClicked();
				}
			});
		}
	...
	private void okClicked() {
		...
		if (!title.equals("") && !notiz.equals("")) {
			...
			this.newNote = note;
			try {
				if (EntryManager.getInstance().updateNote(this.oldNote, this.newNote)) {

...
public class EditAccountView extends JDialog {
	...
	public EditAccountView(Account account) {
		...
		this.initialize();
		this.tf_title.setText(this.oldAccount.getTitle());
		this.tf_uid.setText(this.oldAccount.getUserID());
		this.tf_password.setText(this.oldAccount.getPwd());
		this.ta_note.setText(this.oldAccount.getNote());
		this.tf_link.setText(this.oldAccount.getLink());
	}
	...
	private JButton getJButton1() {
		if (this.btn_cancel == null) {
			...
			this.btn_cancel.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					EditAccountView.this.cancelClicked();
				}
			});
		}
	...
	private JButton getJButton2() {
		if (this.btn_ok == null) {
			...
			this.btn_ok.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					EditAccountView.this.okClicked();
				}
			});
		}
		return this.btn_ok;
	...
	private void okClicked() {
		...
		if (!(title.equals("") || userid.equals("") || pwd.equals(""))) {
			...
			account.setAsscociatedGroup(parentGroup);
			this.newAccount = account;
			try {
				if (EntryManager.getInstance().updateAccount(this.oldAccount, this.newAccount)) {
